...
// ROS
#include <conveyor_gazebo_sim/ConveyorBeltControl.h>
#include <ros/ros.h>
...
namespace gazebo
{
  ...
  class ROSConveyorBeltPlugin : public ConveyorBeltPlugin
  {
    ...
    public: bool OnControlCommand(ros::ServiceEvent<
      conveyor_gazebo_sim::ConveyorBeltControl::Request,
      conveyor_gazebo_sim::ConveyorBeltControl::Response> & event);
